...
--add to Products
Insert into Products Values (N'Nho Ninh Thuận 500g',31000,N'product-4.jpg',N'Nho đỏ có phần thịt dày mọng nước',N'trai-cay-tuoi',0,4,GETDATE(),1,11,N'Còn hàng',N'2 tiếng giao hàng',N'500g',N'Nho đỏ có phần thịt dày mọng nước, vị ngọt xen lẫn chua nhẹ hài hoà, là loại trái cây được nhiều người yêu thích vào những ngày hè. Loại nho đỏ Ninh Thuận  mang lại nhiều lợi ích đối với sức khoẻ, nho ngọt khi có vỏ màu đỏ tím, đậm, chín đều, chắc, mọng.',N'Ngon nhức nách',0,1,0);
Insert into Products Values (N'Thịt ba rọi bò Thảo Tiến Foods khay 300g', 98000, N'product-1.jpg', N'Thịt bò Mỹ Thảo Tiến Foods là loại thịt bò đông lạnh được thái bằng máy tự động trong môi trường lạnh, tạo nên những khoanh thịt đỏ hồng', N'thit-heo-tuoi', 0, 2, GETDATE(), 5, 20, N'Còn hàng', N'12 tiếng giao hàng', N'300 g', N'Thịt bò Mỹ Thảo Tiến Foods là loại thịt bò đông lạnh được thái bằng máy tự động trong môi trường lạnh, tạo nên những khoanh thịt đỏ hồng. Thịt ba rọi bò Mỹ Thảo Tiến Foods khay 300g là phần thịt bò nằm ở phần bụng, có lớp nạc mỡ xen kẽ nhau, tạo nên độ mềm ngọt, thơm ngậy nhưng không ngấy.', N'Trên cả tuyệt vời luôn', 0, 0, 0);
INSERT INTO Products (Name, Price, img, description, meta, hide, [order], datebegin, categoryid, reviews_number, availability,[shipping_day]
      ...
      ,[review_product])
VALUES
(N'Ổi Ruby 1kg (4 - 6 trái)', 27200, N'product-3.jpg', N'Ổi ruby là loại trái cây chất lượng, thơm ngon có lớp vỏ màu xanh lá cây bóng mượt, bên trong có màu đỏ hồng rất bắt mắt và hấp dẫn.', N'trai-cay-tuoi', 0, 3, GETDATE(), 1, 2, N'Còn hàng', N'12 tiếng giao hàng', N'1kg', N'Ổi ruby là loại trái cây chất lượng, thơm ngon có lớp vỏ màu xanh lá cây bóng mượt, bên trong có màu đỏ hồng rất bắt mắt và hấp dẫn. Ổi ruby được rất nhiều người ưa chuộng và chọn mua bởi sự giòn, ngọt của nó.', N'Ổi xanh ngon', 1, 0, 1),
...
(N'Dưa hấu đỏ trái 1.7kg trở lên', 34800, N'product-7.jpg', N'Dưa hấu đỏ là trái cây nhiều nước và các vitamin', N'trai-cay-tuoi', 0, 7, GETDATE(), 1, 12, N'Còn hàng',N'2 tiếng giao hàng', N'1.7kg trở lên', N'Dưa hấu đỏ là trái cây nhiều nước và các vitamin, khoáng chất cần thiết, đặc biệt là ít calo và chất béo. Dưa hấu được xem là một sản phẩm thay thế cho nước uống thông thường. Dưa hấu ngọt khi có vỏ xanh đậm, cuống héo, đuôi quả có vùng vàng.', N'Sản phẩm chất lượng ngon và ngọt lắm', 1, 0, 1),
...
(N'Nước ép cam Vfresh 1 lít', 30000, N'product-11.jpg', N'Nước ép trái cây chất lượng tự thương hiệu nước ép Vfresh', N'nuoc-ep', 0, 10, GETDATE(), 4, 14, N'Còn hàng',N'2 tiếng giao hàng', N'1 lít', N'Nước ép trái cây chất lượng tự thương hiệu nước ép Vfresh. Nước ép cam 100% Vfresh 1 lít từ quả cam tươi ngon, mọng nước, không phẩm màu, không sử dụng chất bảo quản cho hương vị thanh ngọt tự nhiên, giúp giải nhanh cơn khát, cung cấp vitamin và năng lượng cho cơ thể khỏe mạnh', N'Quá xá đã', 0, 1, 0),
